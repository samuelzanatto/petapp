...
const textModerationMiddleware = async (req, res, next) => {
    try { // Verificar campos de texto comuns em requisições
        ...
        for (const { field, content } of textsToModerate) {
            const result = await (0, contentModeration_1.moderateText)(content);
...
exports.textModerationMiddleware = textModerationMiddleware;
/**
 ...
 */
const imageModerationMiddleware = async (req, res, next) => {
    try {
        ...
        for (const file of filesToModerate) {
            ...
            if (file.path) {
                ...
                // Moderar a imagem
                result = await (0, contentModeration_1.moderateImage)(file.path);
            ...
            // Moderação baseada em buffer na memória
                ...
                result = await (0, bufferModeration_1.moderateImageBuffer)(file.buffer, file.mimetype);
...
exports.imageModerationMiddleware = imageModerationMiddleware;
