...
exports.saveBufferToTempFile = exports.moderateImageBuffer = void 0;
/**
 ...
 */
const moderateImageBuffer = async (buffer, mimeType) => {
    ...
    try {
        ...
        if (isFlagged) {
            console.log('Categorias sinalizadas:', Object.entries(unsafeContent)
...
exports.moderateImageBuffer = moderateImageBuffer;
/**
 ...
 */
const saveBufferToTempFile = async (buffer, mimeType) => {
...
exports.saveBufferToTempFile = saveBufferToTempFile;
