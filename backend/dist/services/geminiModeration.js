...
exports.moderateTextBasic = exports.moderateTextWithGemini = void 0;
 ...
 */
const moderateTextWithGemini = async (text) => {
    ...
    if (!geminiClient) {
        return (0, exports.moderateTextBasic)(text);
    }
    try {
...
exports.moderateTextWithGemini = moderateTextWithGemini;
/**
 * Implementação básica de moderação de texto usando uma lista de palavras proibidas
 * @param text Texto para moderar
 */
const moderateTextBasic = (text) => {
    ...
    const containsForbiddenWord = forbiddenWords.some(word => lowerText.includes(word.toLowerCase()));
    return {
...
exports.moderateTextBasic = moderateTextBasic;
