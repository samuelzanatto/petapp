...
exports.createChatForApprovedClaim = exports.sendMessage = exports.createOrGetDirectChat = exports.getChatRoom = exports.getUserChatRooms = exports.createChatRoom = void 0;
...
const getUserChatRooms = async (req, res) => {
    try {
        ...
        const validChatRooms = await Promise.all(chatRooms.map(async (room) => {
...
const getChatRoom = async (req, res) => {
    try {
        ...
        if (!chatRoom.foundPetAlertId && !chatRoom.lostPetAlertId) {
            const approvedClaim = await prisma.petClaim.findFirst({
                where: {
                    OR: [
                        // Caso 1: Usuário atual criou o alerta e o outro fez a reivindicação
...
exports.createOrGetDirectChat = createOrGetDirectChat;
...
const createChatForApprovedClaim = async (claimId) => {
...
exports.createChatForApprovedClaim = createChatForApprovedClaim;
