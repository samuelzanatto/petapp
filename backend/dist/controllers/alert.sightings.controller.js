...
exports.reportPetSighting = void 0;
const client_1 = require("@prisma/client");
const config_1 = require("../config");
const prisma = new client_1.PrismaClient();
// Reportar avistamento de um pet perdido
const reportPetSighting = async (req, res) => {
    try {
        const { alertId, latitude, longitude, locationName, description, contactInfo, sightedAt, hasFoundPet } = req.body;
...
exports.reportPetSighting = reportPetSighting;
