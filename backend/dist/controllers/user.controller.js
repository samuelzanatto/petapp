...
exports.discoverUsers = exports.deleteAccount = exports.getUserPets = exports.searchUsers = exports.getFollowing = exports.getFollowers = exports.followUser = exports.changePassword = exports.updateUserLocation = exports.updateUserProfile = exports.getUserProfile = exports.getMyProfile = void 0;
...
const updateUserProfile = async (req, res) => {
    try {
        const { name, email, bio, phone, whatsappPhone, emergencyPhone, emergencyContact, address, neighborhood, city, state, zipCode, latitude, longitude } = req.body;
        const userId = req.userId;
        if (!userId) {
            return res.status(401).json({ message: 'Usuário não autenticado' });
        }
